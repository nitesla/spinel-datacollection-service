...
public class AuthenticationService {
    ...
    public AuthenticationService(UserService userService, AuditTrailService auditTrailService, PermissionRepository permissionRepository, PermissionService permissionService, UserRoleService userRoleService, EnumeratorRepository enumeratorRepository, ProjectOwnerRepository projectOwnerRepository, TokenService tokenService) {
